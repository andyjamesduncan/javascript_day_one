...
# So let’s get hands on it! We decide we love TV shows so much that checking them on IMDB is not enough. 
# We want to implement a web app where we can keep track of the TV shows we love or hate, writing there our own rating and comments.
